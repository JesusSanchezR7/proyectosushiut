  ...
  return (
    <div className="reservar-container">
      <div className="restauarnte1">
        <button className="reservar-button" onClick={() => handleReservarClick("Calzada Monterrey")}>
          Reservar
        </button>
      </div>
      <div className="restauarnte2">
        <button className="reservar-button" onClick={() => handleReservarClick("Libertad y 43")}>
          Reservar
        </button>
      </div>
      <div className="restauarnte3">
        <button className="reservar-button" onClick={() => handleReservarClick("Av Insurgentes y 2da Cd. Gpe Victoria")}>
          Reservar
        </button>
      </div>
        ...
        <div className="row justify-content-center">
          <form>
            ...
            <div className="d-grid">
              <a className="btn btn-outline-danger">Reservar</a>
            </div>
          </form>
        </div>
      </div>
